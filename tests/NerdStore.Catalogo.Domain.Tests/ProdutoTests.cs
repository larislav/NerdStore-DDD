    ...
    public class ProdutoTests
    {
        ...
        public void Produto_Validar_ValidacoesDevemRetornarExceptions()
        {
            ...
            var ex = Assert.Throws<DomainException>(testCode: () =>
                ...
                DateTime.Now, "Imagem", new Dimensoes(1,1,1))
            );

            Assert.Equal("O campo Nome do produto não pode estar vazio", ex.Message);

            ex = Assert.Throws<DomainException>(testCode: () =>
                new Produto("Nome", string.Empty, false, 100, Guid.NewGuid(),
                DateTime.Now, "Imagem", new Dimensoes(1, 1, 1))
            );
            ...
            ex = Assert.Throws<DomainException>(testCode: () =>
                new Produto("Nome", "Descricao", false, 0, Guid.NewGuid(),
                DateTime.Now, "Imagem", new Dimensoes(1, 1, 1))
            );
            ...
            ex = Assert.Throws<DomainException>(testCode: () =>
                new Produto("Nome", "Descricao", false, 100, Guid.Empty,
                DateTime.Now, "Imagem", new Dimensoes(1, 1, 1))
            );
            ...
            ex = Assert.Throws<DomainException>(testCode: () =>
                new Produto("Nome", "Descricao", false, 100, Guid.NewGuid(),
                DateTime.Now, string.Empty, new Dimensoes(1, 1, 1))
            );
            ...
            ex = Assert.Throws<DomainException>(testCode: () =>
               new Produto("Nome", "Descricao", false, 100, Guid.NewGuid(),
               DateTime.Now, "Imagem", new Dimensoes(0, 1, 1))
           );
